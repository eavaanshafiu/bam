                    ...
                    <div>
                        <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
                            ...
                            <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100">
                                ...
                                <p className="mb-4 text-xs text-gray-100">1-1-2023</p>
                                <div className="flex items-center justify-center space-x-3">
                                    ...
                                    >
                                        <svg viewBox="0 0 16 16" fill="currentColor" className="h-5">
                                            <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3V0Z" fill="white"></path>                                    </svg>
                                    </a>
                                    <a
                                        href=""
                                        className="text-white transition-colors duration-300 hover:text-teal-accent-400"
